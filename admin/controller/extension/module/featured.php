...
class ControllerExtensionModuleFeatured extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['templatefeatur'])) {
			$data['templatefeatur'] = $this->request->post['templatefeatur'];
		} elseif (!empty($module_info)) {
			$data['templatefeatur'] = $module_info['templatefeatur'];
		} else {
			$data['templatefeatur'] = '';
		}

		if (isset($this->request->post['titlefetured'])) {
			$data['titlefetured'] = $this->request->post['titlefetured'];
		} elseif (!empty($module_info)) {
			$data['titlefetured'] = $module_info['titlefetured'];
		} else {
			$data['titlefetured'] = '';
		}
