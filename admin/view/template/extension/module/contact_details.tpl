	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				...
				<a onclick="$('#execute').val('delete');$('#form').submit();" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-product').submit() : false;"><i class="fa fa-trash-o"></i></a>
