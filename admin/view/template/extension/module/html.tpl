    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-templatehtml">Шаблон</label>
            <div class="col-sm-10">
              <input type="text" name="templatehtml" value="<?php echo $templatehtml; ?>" placeholder="Шаблон" id="input-templatehtml" class="form-control" />
            </div>
          </div> 
        </form>
      </div>
