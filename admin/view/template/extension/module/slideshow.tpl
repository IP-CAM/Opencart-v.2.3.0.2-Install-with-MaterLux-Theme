    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-slideshow" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-templateslide">Шаблон</label>
            <div class="col-sm-10">
              <input type="text" name="templateslide" value="<?php echo $templateslide; ?>" placeholder="Шаблон" id="input-templateslide" class="form-control" />
