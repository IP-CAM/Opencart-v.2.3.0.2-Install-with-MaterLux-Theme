...
<div id="content"><div class="container-fluid">
	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div style="background: #20acda;color: #ffffff;font-size: 125%;padding: 10px;border-color: #1978ab;border-radius: 3px;">Еще больше модулей и шаблонов для Opencart 2.x <a style="color: #fffc00;" target="_blank" href="https://youropencart.ru/">на нашем сайте</a>!</div>
	</form>
</div>
<script type="text/javascript"><!--
$('.main-tabs a').tabs();
