...
<div class="form_order">
    ...
    <div class="form_order_row" id="account">
        ...
        <div class="form-group required form_order_col">
            <div class="in_box">
                <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="tx" />
            </div>
        </div>
        ...
        <div class="form-group required form_order_col">
            <div class="in_box">
                <input type="text" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-payment-email" class="tx" />
            </div>
        </div>
        <div class="form-group required form_order_col">
            <div class="in_box">
                <input type="text" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-payment-telephone" class="tx" />
            </div>
        </div>
        ...
        <div class="form-group required form_order_col">
            <div class="in_box">
                <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-payment-address-1" class="tx" />
            </div>
        </div>
    ...
    <div class="form_order_bot">
        <?php foreach ($custom_fields as $custom_field) { ?>
            ...
            <?php if ($custom_field['type'] == 'checkbox') { ?>
            <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form_order_check custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
                <div class="check" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
                    <?php foreach ($custom_field['custom_field_value'] as $custom_field_value) { ?>
