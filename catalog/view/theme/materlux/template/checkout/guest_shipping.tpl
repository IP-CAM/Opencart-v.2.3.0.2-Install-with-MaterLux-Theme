...
<form class="form-horizontal">
    <div class="form_order">
        ...
        <div class="form_order_row">
            <div class="form-group required form_order_col">
                <div class="in_box">
                    <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-shipping-firstname" class="tx" />
                </div>
            </div>
            ...
            <div class="form-group required form_order_col">
                <div class="in_box">
                <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>" id="input-shipping-address-1" class="tx" />
                </div>
            </div>
            ...
            <div class="form-group required form_order_col">
                <div class="in_box">
                <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-shipping-city" class="tx" />
                </div>
            </div>
            <div class="form-group required form_order_col">
                <div class="in_box">
                    <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-shipping-postcode" class="tx" />
                </div>
            </div>
            <div class="form-group required form_order_col">
                <div class="in_box">
