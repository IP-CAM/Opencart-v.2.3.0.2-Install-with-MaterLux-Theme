    ...
    <div class="form_order">
        <?php if ($addresses) { ?>
            ...
            <div id="shipping-existing">
                <select name="address_id" class="form-control address_select">
        ...
        <div class="form_order_row" id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
            <div class="form-group required form_order_col">
                <div class="in_box">
                    <input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-shipping-firstname" class="tx" />
                </div>
            </div>
            <div class="form-group required displaynone">
                ...
                <div class="col-sm-10">
                <input type="text" name="lastname" value="<?php echo $entry_lastname; ?>" placeholder="<?php echo $entry_lastname; ?>" id="input-shipping-lastname" class="form-control" />
                </div>
            </div>
            <div class="form-group displaynone">
                ...
                <div class="col-sm-10">
                <input type="text" name="company" value="<?php echo $entry_company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-shipping-company" class="form-control" />
                </div>
            </div>
            <div class="form-group required form_order_col">
                <div class="in_box">
                    <input type="text" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-shipping-address-1" class="tx" />
                </div>
            </div>
            <div class="form-group displaynone">
                <label class="col-sm-2 control-label" for="input-shipping-address-2"><?php echo $entry_address_2; ?></label>
                <div class="col-sm-10">
                <input type="text" name="address_2" value="<?php echo $entry_address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-shipping-address-2" class="form-control" />
                </div>
            </div>
            ...
            <div class="form-group required displaynone">
                ...
                <div class="col-sm-10">
                <input type="text" name="city" value="<?php echo $entry_city; ?>" placeholder="<?php echo $entry_city; ?>" id="input-shipping-city" class="form-control" />
                </div>
            </div>
            ...
            <div class="form-group required displaynone">
                ...
                <div class="col-sm-10">
                <input type="text" name="postcode" value="<?php echo $entry_postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-shipping-postcode" class="form-control" />
                </div>
            </div>
