...
<div class="selection bf-panel-wrapper<?php if($isResponsive) : ?> bf-responsive<?php endif; ?> <?php echo $responsivePos; ?> bf-layout-id-<?php echo $layout_id;?>">

    <div class="form_selection box bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>">
        <div class="brainyfilter-panel box-content <?php if ($settings['submission']['hide_panel']) : ?>bf-hide-panel<?php endif; ?>">
            <form class="bf-form 
                                ...
                                <div class="form_selection_col">
                                    <div class="selection_data">
                                        ...
                                        <?php if ($group['type'] == 'select') : ?>
                                            ...
                                            <select name="<?php echo "bfp_{$groupUID}"; ?>">
                                                <option value="" class="bf-default">везде</option>
                ...
                <div class="btn_box">
                    <button class="btn_selection" type="submit" onclick="BrainyFilter.sendRequest(jQuery(this));BrainyFilter.loadingAnimation();return false;">Подобрать матрас по параметрам</button>
                </div>
