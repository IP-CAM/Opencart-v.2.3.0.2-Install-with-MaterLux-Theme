...
public function getattributesbygroup() {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['lifemattress'])) {
			$data['lifemattress'] = $this->request->post['lifemattress'];
		} elseif (!empty($product_info)) {
		...
		if (isset($this->request->post['kolvolifes'])) {
			$data['kolvolifes'] = $this->request->post['kolvolifes'];
		} elseif (!empty($product_info)) {
		...
		if (isset($this->request->post['linksale'])) {
			$data['linksale'] = $this->request->post['linksale'];
		} elseif (!empty($product_info)) {
