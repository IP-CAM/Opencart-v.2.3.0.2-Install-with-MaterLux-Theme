...
if (isset($this->request->post['config_fb'])) {
		...
		if (isset($this->request->post['config_insta'])) {
			$data['config_insta'] = $this->request->post['config_insta'];
		} else {
			$data['config_insta'] = $this->config->get('config_insta');
		}
if (isset($this->request->post['config_fartun1'])) {
        $data['config_fartun1'] = $this->request->post['config_fartun1'];
    } else {
        $data['config_fartun1'] = $this->config->get('config_fartun1');
    }
 if (isset($this->request->post['config_fartun2'])) {
        $data['config_fartun2'] = $this->request->post['config_fartun2'];
    } else {
        $data['config_fartun2'] = $this->config->get('config_fartun2');
    }
if (isset($this->request->post['config_fartun3'])) {
        $data['config_fartun3'] = $this->request->post['config_fartun3'];
    } else {
        $data['config_fartun3'] = $this->config->get('config_fartun3');
    }
if (isset($this->request->post['config_fartun4'])) {
        $data['config_fartun4'] = $this->request->post['config_fartun4'];
    } else {
        $data['config_fartun4'] = $this->config->get('config_fartun4');
    }
if (isset($this->request->post['config_fartun5'])) {
        $data['config_fartun5'] = $this->request->post['config_fartun5'];
    } else {
        $data['config_fartun5'] = $this->config->get('config_fartun5');
    }
if (isset($this->request->post['config_fartun6'])) {
        $data['config_fartun6'] = $this->request->post['config_fartun6'];
    } else {
        $data['config_fartun6'] = $this->config->get('config_fartun6');
    }
if (isset($this->request->post['config_fartun7'])) {
        $data['config_fartun7'] = $this->request->post['config_fartun7'];
    } else {
        $data['config_fartun7'] = $this->config->get('config_fartun7');
    }
if (isset($this->request->post['config_fartun8'])) {
        $data['config_fartun8'] = $this->request->post['config_fartun8'];
    } else {
        $data['config_fartun8'] = $this->config->get('config_fartun8');
    }
