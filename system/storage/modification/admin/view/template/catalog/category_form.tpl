  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="button" onclick="SaS();" type="button" form="form-category" data-toggle="tooltip" title="save and stay" class="btn btn-primary"><i class="fa fa-repeat"></i></button>
