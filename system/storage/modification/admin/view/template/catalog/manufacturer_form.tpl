      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-manufacturer" class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" id="title-slug<?php echo $langC; ?>" name="name" value="<?php echo $name; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name" class="form-control" />
              <?php if ($error_name) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" id="slug-result<?php echo $langC; ?>" name="keyword" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_keyword; ?>" id="input-keyword" class="form-control" />
