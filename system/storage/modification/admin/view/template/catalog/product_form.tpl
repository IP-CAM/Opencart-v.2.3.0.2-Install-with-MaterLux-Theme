        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-composition<?php echo $language['language_id']; ?>">Состав</label>
                    <div class="col-sm-10">
                      <textarea name="product_description[<?php echo $language['language_id']; ?>][composition]" placeholder="<?php echo $entry_description; ?>" id="input-composition<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['composition'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Срок службы матраса</label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($lifemattress) { ?>
                    <input type="radio" name="lifemattress" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="lifemattress" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$lifemattress) { ?>
                    <input type="radio" name="lifemattress" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="lifemattress" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-kolvolifes"><span data-toggle="tooltip">Количество лет службы</span></label>
                <div class="col-sm-10">
                  <input type="text" name="kolvolifes" value="<?php echo $kolvolifes; ?>" id="input-kolvolifes" class="form-control" />
                </div>
              </div>
              <div class="form-group">
...
<div class="form-group">
  <label class="col-sm-2 control-label" for="input-attribute_group_id"><?php echo 'Группа Атрибутов'; ?></label>
  <div class="col-sm-10">
	...
	<?php } ?>
            ...
            <div class="tab-pane" id="tab-special">
              <div class="table-responsive">
				...
				<div class="form-group">
                <label class="col-sm-4 control-label" for="input-linksale"><span data-toggle="tooltip">Ссылка на страницу со скидкой</span></label>
                <div class="col-sm-7">
                  <input type="text" name="linksale" value="<?php echo $linksale; ?>" id="input-linksale" class="form-control" />
                </div>
              </div>
              </div>
            </div>
