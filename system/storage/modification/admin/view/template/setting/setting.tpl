...
<div class="form-group">
	...
	<div class="col-sm-10">
	<input type="text" name="config_fb" value="<?php echo $config_fb; ?>" placeholder="Ссылка facebook" id="input-fb" class="form-control" />
	</div>
</div>
...
<div class="form-group">
	<label class="col-sm-2 control-label" for="input-insta">Ссылка instagram</label>
	<div class="col-sm-10">
	<input type="text" name="config_insta" value="<?php echo $config_insta; ?>" placeholder="Ссылка instagram" id="input-insta" class="form-control" />
	</div>
</div>

<div class="form-group">
    <label class="col-sm-2 control-label" for="config_fartun1">Наматрасник простынь Промокод</label>
    <div class="col-sm-10">
    <input type="text" name="config_fartun1" value="<?php echo $config_fartun1; ?>" placeholder="Ссылка instagram" id="config_fartun1" class="form-control" />
    </div>
</div>

<div class="form-group">
    <label class="col-sm-2 control-label" for="config_fartun2">Подушка латексная</label>
    <div class="col-sm-10">
    <input type="text" name="config_fartun2" value="<?php echo $config_fartun2; ?>" placeholder="Подушка латексная Промокод" id="config_fartun2" class="form-control" />
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="config_fartun3">Наматрасник lux</label>
    <div class="col-sm-10">
    <input type="text" name="config_fartun3" value="<?php echo $config_fartun3; ?>" placeholder="Наматрасник lux Промокод" id="config_fartun3" class="form-control" />
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="config_fartun4">Подушка детская</label>
    <div class="col-sm-10">
    <input type="text" name="config_fartun4" value="<?php echo $config_fartun4; ?>" placeholder="Подушка детская Промокод" id="config_fartun4" class="form-control" />
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="config_fartun5">Подушка «с памятью»</label>
    <div class="col-sm-10">
    <input type="text" name="config_fartun5" value="<?php echo $config_fartun5; ?>" placeholder="Подушка «с памятью» Промокод" id="config_fartun5" class="form-control" />
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="config_fartun6">Одеяло</label>
    <div class="col-sm-10">
    <input type="text" name="config_fartun6" value="<?php echo $config_fartun6; ?>" placeholder="Одеяло Промокод" id="config_fartun6" class="form-control" />
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="config_fartun7">Подушка «с волной»</label>
    <div class="col-sm-10">
    <input type="text" name="config_fartun7" value="<?php echo $config_fartun7; ?>" placeholder="Подушка «с волной» Промокод" id="config_fartun7" class="form-control" />
    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 control-label" for="config_fartun8">Наматрасник Classic</label>
    <div class="col-sm-10">
    <input type="text" name="config_fartun8" value="<?php echo $config_fartun8; ?>" placeholder="Наматрасник Classic Промокод" id="config_fartun8" class="form-control" />
    </div>
</div>
